"""
Django settings for volunteer_bridge project.
...
SECRET_KEY = 'django-insecure-a86!mrd=x()wsp0cy_eap9tv#=cd0#6*$@i)uq49!!t&az-_8m'
...
WSGI_APPLICATION = 'volunteer_bridge.wsgi.application'
